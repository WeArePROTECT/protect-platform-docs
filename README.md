...
- **[PROTECT Data Integration Pipeline](data-infrastructure/integration-pipeline/)** — Production system (v1.1) unifying the PROTECT data streams (isolate records, clinical metadata, isolation provenance, multi-omics, Conrad sample metadata) into analysis-ready linked tables
